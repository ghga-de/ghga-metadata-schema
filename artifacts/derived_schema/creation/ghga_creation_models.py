...
class CreateSubmission:
    ...
    has_sample: Optional[Union[List[CreateSample], str]] = Field(None, description="""Information about one or more Sample entities associated with this submission.""")
    has_biospecimen: Optional[Union[List[CreateBiospecimen], str]] = Field(None, description="""Information about one or more Biospecimen entities associated with this submission.""")
    has_individual: Optional[Union[List[CreateIndividual], str]] = Field(None, description="""Information about one or more Individual entities associated with this submission.""")
    has_experiment: Optional[Union[List[CreateExperiment], str]] = Field(None, description="""Information about one or more Experiment entities associated with this submission.""")
    has_analysis: Optional[Union[List[CreateAnalysis], str]] = Field(None, description="""Information about one or more Analysis entities associated with this submission.""")
    has_file: Optional[Union[List[CreateFile], str]] = Field(None, description="""Information about one or more File entities associated with this submission.""")
...
class CreateAnalysisProcess(PlannedProcess):
    ...
    """
    title: Optional[str] = Field(None, description="""The title that describes an entity.""")
    has_input: Optional[Union[List[CreateFile], str]] = Field(None, description="""The input data File entities used in the Analysis Process.""")
    ...
    has_output: Optional[Union[List[CreateFile], str]] = Field(None, description="""The output data File entities generated by the Analysis Process.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
    schema_type: Optional[str] = Field(None, description="""The schema type an instance corresponds to.""")
    schema_version: Optional[str] = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class CreateBiospecimen(MaterialEntity):
    ...
    has_disease: Optional[Union[List[CreateDisease], str]] = Field(None, description="""The Disease entity that is associated with the Individual. Typically, a concept from Mondo Disease Ontology. For example, 'MONDO:0005267' indicates that the Individual suffers from 'Heart Disease'.""")
    has_phenotypic_feature: Optional[Union[List[CreatePhenotypicFeature], str]] = Field(None, description="""The Phenotypic Feature entity that is associated with the Individual. Typically, a concept from Human Phenotype Ontology. For example, 'HP:0100244' indicates that the Individual exhibits 'Fibrosarcoma' as one of its phenotype.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
    schema_type: Optional[str] = Field(None, description="""The schema type an instance corresponds to.""")
    schema_version: Optional[str] = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class CreateFamily(Population):
    ...
    """
    has_member: Optional[Union[List[CreateIndividual], str]] = Field(None, description="""One or more Individuals that collectively define this Family.""")
    has_proband: Optional[Union[CreateIndividual, str]] = Field(None, description="""The Individual that is reported to have a disorder which results in the Family being brought into a Study.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: Optional[str] = Field(None, description="""The name for an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
...
class CreateCohort(Population):
    ...
    """
    has_member: Optional[Union[List[CreateIndividual], str]] = Field(None, description="""One or more Individuals that collectively define this Cohort.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: Optional[str] = Field(None, description="""The name for an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
...
class CreateExperiment(Investigation):
    ...
    has_file: Optional[Union[List[CreateFile], str]] = Field(None, description="""One or more Files entities that are generated as output of this Experiment.""")
    has_protocol: Union[List[CreateProtocol], str] = Field(None, description="""One or more Protocol entities associated with this Experiment.""")
    has_experiment_process: Optional[Union[List[CreateExperimentProcess], str]] = Field(None, description="""One or more Experiment Processes entities associated with this Experiment.""")
...
class CreateIndividual(Person):
    ...
    has_parent: Optional[Union[List[CreateIndividual], str]] = Field(None, description="""One or more parent for this Individual.""")
    has_children: Optional[Union[List[CreateIndividual], str]] = Field(None, description="""One or more children for this Individual.""")
    has_disease: Optional[Union[List[CreateDisease], str]] = Field(None, description="""The Disease entity that is associated with this Biospecimen at the time of retrieval from the organism. Typically, a concept from Mondo Disease Ontology. For example, 'MONDO:0003742' indicates that the Individual - from which the Biospecimen was extracted from - suffers from 'Heart Fibrosarcoma'.""")
...
class CreateDonor(CreateIndividual):
    ...
    geographical_region: Optional[str] = Field(None, description="""The geographical region where the Individual is located. Any demarcated area of the Earth; may be determined by both natural and human boundaries.""")
    ancestry: Optional[str] = Field(None, description="""A person's descent or lineage, from a person or from a population.""")
    has_parent: Optional[Union[List[CreateIndividual], str]] = Field(None, description="""The parent of an entity.""")
    has_children: Optional[Union[List[CreateIndividual], str]] = Field(None, description="""The children of an entity.""")
    has_disease: Optional[Union[List[CreateDisease], str]] = Field(None, description="""Disease concept that the entity is associated with.""")
    has_phenotypic_feature: Optional[Union[List[CreatePhenotypicFeature], str]] = Field(None, description="""Phenotypic feature concept that the entity is associated with.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: Optional[str] = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    given_name: Optional[str] = Field(None, description="""First name.""")
    family_name: Optional[str] = Field(None, description="""Last name.""")
...
class CreateAnalysis(DataTransformation):
    ...
    has_input: Union[List[CreateFile], str] = Field(None, description="""The input data File entities used in the Analysis.""")
    has_study: Optional[Union[CreateStudy, str]] = Field(None, description="""The Study entity associated with this Analysis.""")
    has_workflow: Optional[Union[CreateWorkflow, str]] = Field(None, description="""The Workflow entity associated with this Analysis.""")
    has_analysis_process: Optional[Union[List[CreateAnalysisProcess], str]] = Field(None, description="""One or more Analysis Process entities associated with this Analysis.""")
    has_output: Optional[Union[List[CreateFile], str]] = Field(None, description="""The output data File entities generated by this Analysis.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: Optional[str] = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    title: Optional[str] = Field(None, description="""The title that describes an entity.""")
...
class CreateDataAccessCommittee(Committee):
    ...
    has_member: Optional[Union[List[CreateMember], str]] = Field(None, description="""All the members that are part of this Data Access Committee.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: Optional[str] = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
...
class DeprecatedMixin:
    ...
    """
    replaced_by: Optional[NamedThing] = Field(None, description="""Refers to the entity which replaces a currently deprecated entity.""")
...
class CreateStudy(Investigation):
    ...
    has_experiment: Optional[Union[List[CreateExperiment], str]] = Field(None, description="""One or more Experiment entities associated with this Study.""")
    has_analysis: Optional[Union[List[CreateAnalysis], str]] = Field(None, description="""One or more Analysis entities associated with this Study.""")
    ...
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: Optional[str] = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    has_publication: Optional[Union[List[CreatePublication], str]] = Field(None, description="""One or more Publication entities associated with this Study.""")
...
class CreateDataset(InformationContentEntity):
    ...
    has_study: Union[List[CreateStudy], str] = Field(None, description="""One or more Study entities that are referenced by this Dataset.""")
    has_experiment: Union[List[CreateAnalysis], str] = Field(None, description="""One or more Analysis entities that are referenced by this Dataset.""")
    has_sample: Union[List[CreateStudy], str] = Field(None, description="""One or more Sample entities that are referenced by this Dataset.""")
    has_analysis: Union[List[CreateStudy], str] = Field(None, description="""One or more Analysis entities that are referenced by this Dataset.""")
    has_file: Union[List[CreateFile], str] = Field(None, description="""One or more File entities that collectively are part of this Dataset.""")
    ...
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: Optional[str] = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    has_publication: Optional[Union[List[CreatePublication], str]] = Field(None, description="""One or more Publication entities associated with this Dataset.""")
...
CreateSubmission.__pydantic_model__.update_forward_refs()
...
CreateAgent.__pydantic_model__.update_forward_refs()
...
CreateExperimentProcess.__pydantic_model__.update_forward_refs()
CreateTechnology.__pydantic_model__.update_forward_refs()
CreateWorkflow.__pydantic_model__.update_forward_refs()
CreateWorkflowStep.__pydantic_model__.update_forward_refs()
CreateDiseaseOrPhenotypicFeature.__pydantic_model__.update_forward_refs()
Population.__pydantic_model__.update_forward_refs()
CreateAnalysisProcess.__pydantic_model__.update_forward_refs()
CreateMember.__pydantic_model__.update_forward_refs()
CreatePublication.__pydantic_model__.update_forward_refs()
CreateAnatomicalEntity.__pydantic_model__.update_forward_refs()
CreateCellLine.__pydantic_model__.update_forward_refs()
CreateDisease.__pydantic_model__.update_forward_refs()
CreatePhenotypicFeature.__pydantic_model__.update_forward_refs()
CreateUser.__pydantic_model__.update_forward_refs()
AccessionMixin.__pydantic_model__.update_forward_refs()
CreateBiospecimen.__pydantic_model__.update_forward_refs()
CreateFamily.__pydantic_model__.update_forward_refs()
CreateCohort.__pydantic_model__.update_forward_refs()
EgaAccessionMixin.__pydantic_model__.update_forward_refs()
CreateExperiment.__pydantic_model__.update_forward_refs()
CreateSample.__pydantic_model__.update_forward_refs()
CreateIndividual.__pydantic_model__.update_forward_refs()
CreateDonor.__pydantic_model__.update_forward_refs()
CreateFile.__pydantic_model__.update_forward_refs()
CreateAnalysis.__pydantic_model__.update_forward_refs()
CreateDataAccessPolicy.__pydantic_model__.update_forward_refs()
CreateDataAccessCommittee.__pydantic_model__.update_forward_refs()
AttributeMixin.__pydantic_model__.update_forward_refs()
CreateProject.__pydantic_model__.update_forward_refs()
CreateProtocol.__pydantic_model__.update_forward_refs()
CreateLibraryPreparationProtocol.__pydantic_model__.update_forward_refs()
CreateSequencingProtocol.__pydantic_model__.update_forward_refs()
...
CreateStudy.__pydantic_model__.update_forward_refs()
CreateDataset.__pydantic_model__.update_forward_refs()
