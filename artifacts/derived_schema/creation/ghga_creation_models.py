...
class CreateSubmission(BaseModel):
    ...
    has_sample: Union[List[CreateSample], List[str]] = Field(None, description="""Information about one or more Sample entities associated with this submission.""")
    ...
    has_individual: Union[List[AnnotatedCreateIndividual], List[str]] = Field(None, description="""Information about one or more Individual entities associated with this submission.""")
    has_experiment: Union[List[CreateExperiment], List[str]] = Field(None, description="""Information about one or more Experiment entities associated with this submission.""")
    has_protocol: Union[List[AnnotatedCreateProtocol], List[str]] = Field(None, description="""One or more Protocol entities associated with this Submission.""")
...
class CreateSample(MaterialEntity):
    ...
    has_anatomical_entity: Union[List[CreateAnatomicalEntity], List[str]] = Field(None, description="""Anatomical site associated with an entity.""")
