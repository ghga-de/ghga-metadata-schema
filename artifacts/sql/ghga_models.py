...
tbl_aggregate_dataset = Table('aggregate_dataset', metadata, 
    ...
    Column('deprecation_date', Text),
    Column('replaced_by', Text, ForeignKey('named_thing.id')),
)
...
tbl_disease = Table('disease', metadata, 
    ...
    Column('name', Text),
    Column('description', Text),
    Column('biospecimen_id', Text, ForeignKey('biospecimen.id')),
)
...
tbl_submission_xref = Table('submission_xref', metadata, 
    Column('backref_id', Text, ForeignKey('submission.id'), primary_key=True),
    Column('xref', Text, primary_key=True),
)
...
mapper_registry.map_imperatively(Biospecimen, tbl_biospecimen, properties={
    ...
    'has_disease': 
        relationship(Disease, 
                      foreign_keys=tbl_disease.columns["biospecimen_id"],
                      backref='Biospecimen'),


    'has_phenotypic_feature': 
        relationship(PhenotypicFeature, 
                      foreign_keys=tbl_phenotypic_feature.columns["biospecimen_id"],
                      backref='Biospecimen'),
