...
class Submission(BaseModel):
    ...
    has_sample: Union[List[Sample], List[str]] = Field(None, description="""Information about one or more Sample entities associated with this submission.""")
    ...
    has_individual: Union[List[AnnotatedIndividual], List[str]] = Field(None, description="""Information about one or more Individual entities associated with this submission.""")
    has_experiment: Union[List[Experiment], List[str]] = Field(None, description="""Information about one or more Experiment entities associated with this submission.""")
    has_protocol: Union[List[AnnotatedProtocol], List[str]] = Field(None, description="""One or more Protocol entities associated with this Submission.""")
...
class Family(Population):
    ...
    """
    has_individual: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""One or more Individuals that collectively define this Family.""")
    has_proband: Optional[Union[AnnotatedIndividual, str]] = Field(None, description="""The Individual that is reported to have a disorder which results in the Family being brought into a Study.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: Optional[str] = Field(None, description="""The name for an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: Optional[str] = Field(None, description="""The alias for an entity.""")
...
class Cohort(Population):
    ...
    """
    has_individual: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""One or more Individuals that collectively define this Cohort.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: Optional[str] = Field(None, description="""The name for an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: Optional[str] = Field(None, description="""The alias for an entity.""")
...
class ExperimentProcess(PlannedProcess):
    ...
    has_protocol: Optional[Union[AnnotatedProtocol, str]] = Field(None, description="""The Protocol entity used by this Experiment Process.""")
    ...
    has_output: Optional[Union[List[File], List[str]]] = Field(None, description="""The output of this Experiment Process. Usually a File entity.""")
    has_attribute: Optional[List[Attribute]] = Field(None, description="""Key/value pairs corresponding to an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: Optional[str] = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
...
class Sample(MaterialEntity):
    ...
    has_individual: Optional[Union[AnnotatedIndividual, str]] = Field(None, description="""The Individual from which this Sample was derived from.""")
    has_anatomical_entity: Union[List[AnatomicalEntity], List[str]] = Field(None, description="""Anatomical site associated with an entity.""")
...
class DataAccessPolicy(InformationContentEntity):
    ...
    policy_url: str = Field(None, description="""URL for the policy, if available. This is useful if the terms of the policy is made available online at a resolvable URL.""")
    ...
    has_data_use_modifier: Optional[Union[List[DataUseModifier], List[str]]] = Field(None, description="""Modifier for Data use permission associated with a policy. Should be descendants of 'DUO:0000017 data use modifier'""")
...
class Dataset(InformationContentEntity):
    ...
    has_experiment: Union[List[Experiment], List[str]] = Field(None, description="""One or more Experiment entities that are referenced by this Dataset.""")
