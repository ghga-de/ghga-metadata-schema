...
class WorkflowParameter(BaseModel):
    ...
    """
    key: str = Field(None, description="""Key that represents the parameter name.""")
    value: str = Field(None, description="""Value corresponding to the the parameter key.""")
...
class MetadataMixin(BaseModel):
    ...
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class NamedThing(BaseModel):
    ...
    xref: List[str] = Field(None, description="""Holds one or more database cross references for an entity.""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
...
class Technology(InformationContentEntity):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["Technology"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class Workflow(InformationContentEntity):
    ...
    """
    name: str = Field(None, description="""The name for an entity.""")
    has_workflow_step: Union[List[WorkflowStep], List[str]] = Field(None, description="""The individual workflow step that with other workflow step(s) collectively defines a Workflow entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: List[str] = Field(None, description="""Database cross references for an entity.""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["Workflow"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class WorkflowStep(InformationContentEntity):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["WorkflowStep"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class DiseaseOrPhenotypicFeature(BiologicalQuality):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["DiseaseOrPhenotypicFeature"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class AnalysisProcess(PlannedProcess):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["AnalysisProcess"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class DataUseCondition(InformationContentEntity):
    ...
    """
    has_data_use_permission: Union[DataUsePermission, str] = Field(None, description="""Data use permission associated with a policy. Typically one or more terms from DUO and should be descendants of 'DUO:0000001 data use permission'.""")
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["DataUseCondition"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class Publication(InformationContentEntity):
    ...
    """
    title: str = Field(None, description="""The title for the Publication.""")
    ...
    author: str = Field(None, description="""The individual who is responsible for the content of a document version.""")
    year: int = Field(None, description="""Year in which the paper was published.""")
    journal: str = Field(None, description="""Name of the journal.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""One or more cross-references for this Publication.""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["Publication"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class AnatomicalEntity(MaterialEntity):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["AnatomicalEntity"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class PhenotypicFeature(DiseaseOrPhenotypicFeature):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["PhenotypicFeature"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class Submission(BaseModel):
    ...
    affiliation: str = Field(None, description="""Institution/Center/Data Hub that is providing this submission.""")
    has_study: Union[Study, str] = Field(None, description="""Information about a Study entities associated with this submission.""")
    ...
    has_individual: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""Information about one or more Individual entities associated with this submission.""")
    ...
    has_protocol: Optional[Union[List[AnnotatedProtocol], List[str]]] = Field(None, description="""One or more Protocol entities associated with this Submission.""")
    ...
    has_file: Union[List[File], List[str]] = Field(None, description="""Information about one or more File entities associated with this submission.""")
    has_dataset: Union[List[Dataset], List[str]] = Field(None, description="""One or more Dataset that are part of this submission.""")
    has_data_access_policy: Union[List[DataAccessPolicy], List[str]] = Field(None, description="""The Data Access Policy that applies to Dataset in this submission.""")
    has_data_access_committee: Union[List[DataAccessCommittee], List[str]] = Field(None, description="""The Data Access Committee that applies to Dataset in this submission.""")
    has_member: Union[List[Member], List[str]] = Field(None, description="""One or more member that are part of the Data Access Committee referenced in this submission.""")
    ...
    submission_status: Optional[str] = Field(None, description="""The status of a Submission.""")
...
class DataUsePermission(InformationContentEntity):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["DataUsePermission"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class DataUseModifier(InformationContentEntity):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["DataUseModifier"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class AccessionMixin(BaseModel):
    ...
    """
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
...
class Biospecimen(MaterialEntity):
    ...
    has_individual: Union[AnnotatedIndividual, str] = Field(None, description="""The Individual entity from which this Biospecimen was derived.""")
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: List[str] = Field(None, description="""Database cross references for an entity.""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["Biospecimen"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class Family(Population):
    ...
    """
    has_individual: Union[List[AnnotatedIndividual], List[str]] = Field(None, description="""One or more Individuals that collectively define this Family.""")
    has_proband: Union[AnnotatedIndividual, str] = Field(None, description="""The Individual that is reported to have a disorder which results in the Family being brought into a Study.""")
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: str = Field(None, description="""The name for an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
...
class Cohort(Population):
    ...
    """
    has_individual: Union[List[AnnotatedIndividual], List[str]] = Field(None, description="""One or more Individuals that collectively define this Cohort.""")
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: str = Field(None, description="""The name for an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
...
class EgaAccessionMixin(BaseModel):
    ...
    """
    ega_accession: str = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
...
class Individual(Person):
    ...
    karyotype: str = Field(None, description="""The karyotype of an individual if defined.""")
    ...
    has_parent: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""One or more parent for this Individual.""")
    has_children: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""One or more children for this Individual.""")
    has_disease: Union[List[Disease], List[str]] = Field(None, description="""The Disease entity that is associated with this Biospecimen at the time of retrieval from the organism. Typically, a concept from Mondo Disease Ontology. For example, 'MONDO:0003742' indicates that the Individual - from which the Biospecimen was extracted from - suffers from 'Heart Fibrosarcoma'.""")
    ...
    has_file: Optional[Union[List[File], List[str]]] = Field(None, description="""Additional/supplementary files associated with an Individual. Typically, a phenopacket or pedigree file.""")
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: str = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    given_name: Optional[str] = Field(None, description="""First name.""")
    family_name: Optional[str] = Field(None, description="""Last name.""")
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["Individual"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class Donor(Individual):
    ...
    geographical_region: Optional[str] = Field(None, description="""The geographical region where the Individual is located. Any demarcated area of the Earth; may be determined by both natural and human boundaries.""")
    has_ancestry: Optional[Union[List[Ancestry], List[str]]] = Field(None, description="""A person's descent or lineage, from a person or from a population. Typically this is a value from HANCESTRO (Human Ancestry Ontology).""")
    has_parent: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""The parent of an entity.""")
    has_children: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""The children of an entity.""")
    has_disease: Union[List[Disease], List[str]] = Field(None, description="""Disease concept that the entity is associated with.""")
    ...
    has_file: Optional[Union[List[File], List[str]]] = Field(None, description="""The file associated with an entity.""")
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: str = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    given_name: Optional[str] = Field(None, description="""First name.""")
    family_name: Optional[str] = Field(None, description="""Last name.""")
...
class Analysis(DataTransformation):
    ...
    has_study: Union[Study, str] = Field(None, description="""The Study entity associated with this Analysis.""")
    has_workflow: Union[List[Workflow], List[str]] = Field(None, description="""One or more Workflow entities associated with this Analysis.""")
    has_analysis_process: Union[List[AnalysisProcess], List[str]] = Field(None, description="""One or more Analysis Process entities associated with this Analysis.""")
    has_output: Union[List[File], List[str]] = Field(None, description="""The output data File entities generated by this Analysis.""")
    description: str = Field(None, description="""Describing how an Analysis was carried out. (e.g.: computational tools, settings, etc.).""")
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: str = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    title: str = Field(None, description="""The title that describes an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
...
class AttributeMixin(BaseModel):
    ...
    """
    has_attribute: List[Attribute] = Field(None, description="""Key/value pairs corresponding to an entity.""")
...
class Project(ResearchActivity):
    ...
    """
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    has_attribute: List[Attribute] = Field(None, description="""Custom attributes for the Project  (eg: Cancer - Colon cancer, prostrate cancer, blood cancer etc)""")
...
class Experiment(Investigation):
    ...
    has_sample: Union[List[Sample], List[str]] = Field(None, description="""The Sample entity associated with this Experiment.""")
    ...
    has_protocol: Union[List[AnnotatedProtocol], List[str]] = Field(None, description="""One or more Protocol entities associated with this Experiment.""")
    has_experiment_process: Union[List[ExperimentProcess], List[str]] = Field(None, description="""One or more Experiment Processes entities associated with this Experiment.""")
    has_attribute: List[Attribute] = Field(None, description="""Key/value pairs corresponding to an entity.""")
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: str = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["Experiment"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class ExperimentProcess(PlannedProcess):
    ...
    """
    type: ExperimentProcessTypeEnum = Field(None, description="""The type of experiment process.""")
    ...
    has_input: Union[Sample, str] = Field(None, description="""The input to the Experiment Process. Usually a Sample entity.""")
    has_protocol: Union[AnnotatedProtocol, str] = Field(None, description="""The Protocol entity used by this Experiment Process.""")
    has_agent: Union[Agent, str] = Field(None, description="""The Agent - a software, institution, or human - that is executing or responsible for executing the Experiment Process.""")
    has_output: Union[List[File], List[str]] = Field(None, description="""The output of this Experiment Process. Usually a File entity.""")
    has_attribute: List[Attribute] = Field(None, description="""Key/value pairs corresponding to an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: List[str] = Field(None, description="""Database cross references for an entity.""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["ExperimentProcess"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class Protocol(InformationContentEntity):
    ...
    """
    name: str = Field(None, description="""Name of the protocol (eg: Sample extraction_PCR amplification).""")
    type: str = Field(None, description="""Type of the protocol (eg: Target enrichment).""")
    description: str = Field(None, description="""Detailed description of the Protocol.""")
    url: str = Field(None, description="""URL for the resource that describes this Protocol.""")
    has_file: str = Field(None, description="""A document that describes the Protocol.""")
    has_attribute: List[Attribute] = Field(None, description="""One or more attributes that further characterizes this Protocol.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: List[str] = Field(None, description="""One or more cross-references for this Protocol.  (Eg: manufacturer protocol, protocol from publication etc )""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["Protocol"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class LibraryPreparationProtocol(Protocol):
    ...
    url: str = Field(None, description="""A URL to a resource.""")
    has_file: str = Field(None, description="""The file associated with an entity.""")
    has_attribute: List[Attribute] = Field(None, description="""One or more attributes that further characterizes this Library Preparation Protocol.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: List[str] = Field(None, description="""Database cross references for an entity.""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
...
class SequencingProtocol(Protocol):
    ...
    name: str = Field(None, description="""The name for an entity.""")
    type: str = Field(None, description="""Name of the library preparation protocol (eg: mRNA-seq,Whole exome long-read sequencing etc).""")
    ...
    url: str = Field(None, description="""A URL to a resource.""")
    has_file: str = Field(None, description="""The file associated with an entity.""")
    has_attribute: List[Attribute] = Field(None, description="""One or more attributes that further characterizes this Sequencing Protocol.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: str = Field(None, description="""The alias for an entity.""")
    xref: List[str] = Field(None, description="""Database cross references for an entity.""")
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
...
class Sample(MaterialEntity):
    ...
    type: str = Field(None, description="""The type of sample.""")
    ...
    isolation: Optional[str] = Field(None, description="""Method or device employed for collecting/isolating a biospecimen or a sample.""")
    storage: Optional[str] = Field(None, description="""Methods by which a biospecimen or a sample is stored (e.g. frozen in liquid nitrogen).""")
    has_individual: Union[AnnotatedIndividual, str] = Field(None, description="""The Individual from which this Sample was derived from.""")
...
class DataAccessPolicy(InformationContentEntity):
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["DataAccessPolicy"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class DataAccessCommittee(Committee):
    ...
    description: str = Field(None, description="""A description for the Data Access Committee.""")
    ...
    creation_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
    update_date: str = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was updated.""")
    schema_type: Literal["DataAccessCommittee"]
    schema_version: str = Field(None, description="""The version of the schema an instance corresponds to.""")
...
class PublicationMixin(BaseModel):
    ...
    """
    has_publication: str = Field(None, description="""The Publication associated with an entity.""")
...
class DeprecatedMixin(BaseModel):
    ...
    """
    replaced_by: str = Field(None, description="""Refers to the entity which replaces a currently deprecated entity.""")
    deprecation_date: str = Field(None, description="""The timestamp (in ISO 8601 format) when the entity was deprecated.""")
...
class ReleaseStatusMixin(BaseModel):
    ...
    """
    release_status: str = Field(None, description="""The release status of an entity.""")
    release_date: str = Field(None, description="""The timestamp (in ISO 8601 format) when the entity was released for public consumption.""")
...
class Study(Investigation):
    ...
    has_file: Optional[Union[List[File], List[str]]] = Field(None, description="""Additional/supplementary files associated with a Study.""")
    ...
    accession: str = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: str = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    has_attribute: List[Attribute] = Field(None, description="""Custom key/value pairs that further characterizes the Study. (e.g.: approaches - single-cell, bulk etc)""")
    release_status: ReleaseStatusEnum = Field(None, description="""The release status of a Study.""")
    release_date: str = Field(None, description="""The timestamp (in ISO 8601 format) when the entity was released for public consumption.""")
...
AnnotatedIndividual = Annotated[Union[Donor,Individual],
Field(discriminator="schema_type")]
AnnotatedProtocol = Annotated[Union[SequencingProtocol,LibraryPreparationProtocol,Protocol],
Field(discriminator="schema_type")]
