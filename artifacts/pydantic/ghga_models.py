...
class Submission(BaseModel):
    ...
    has_data_access_policy: Optional[Union[List[DataAccessPolicy], List[str]]] = Field(None, description="""The Data Access Policy that applies to Dataset in this submission.""")
...
class Biospecimen(MaterialEntity):
    ...
    has_individual: Optional[Union[AnnotatedIndividual, str]] = Field(None, description="""The Individual entity from which this Biospecimen was derived.""")
...
class SequencingProtocol(Protocol):
    ...
    seq_forward_or_reverse: Optional[ForwardOrReverseEnum] = Field(None, description="""Denotes whether a submitted FASTQ file contains forward (R1) or reverse (R2) reads for paired-end sequencing. The number that identifies each read direction in a paired-end nucleotide sequencing reaction.""")
