...
class Submission(BaseModel):
    ...
    has_member: Optional[Union[List[Member], List[str]]] = Field(None, description="""One or more member that are part of the Data Access Committee referenced in this submission.""")
