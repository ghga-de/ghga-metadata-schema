...
class AnalysisProcess(PlannedProcess):
    ...
    has_workflow: Optional[str] = Field(None, description="""The Workflow entity associated with this Analysis Process.""")
    has_agent: Optional[str] = Field(None, description="""The Agent - a software, institution, or human - that is executing or responsible for executing the workflow.""")
...
class DataUseCondition(InformationContentEntity):
    ...
    """
    has_data_use_permission: str = Field(None, description="""Data use permission associated with a policy. Typically one or more terms from DUO and should be descendants of 'DUO:0000001 data use permission'.""")
    has_data_use_modifier: Optional[str] = Field(None, description="""Modifier for Data use permission associated with a policy. Should be descendants of 'DUO:0000017 data use modifier'""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: Optional[str] = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
    creation_date: Optional[str] = Field(None, description="""Timestamp (in ISO 8601 format) when the entity was created.""")
...
class Submission(BaseModel):
    ...
    has_study: Optional[str] = Field(None, description="""Information about a Study entities associated with this submission.""")
    has_project: Optional[str] = Field(None, description="""Information about a Project entity associated with this submission.""")
    ...
    has_dataset: Optional[Union[List[Dataset], List[str]]] = Field(None, description="""One or more Dataset that are part of this submission.""")
    has_data_access_policy: Optional[List[str]] = Field(None, description="""The Data Access Policy that applies to Dataset in this submission.""")
    has_data_access_committee: Optional[Union[List[DataAccessCommittee], List[str]]] = Field(None, description="""The Data Access Committee that applies to Dataset in this submission.""")
    has_member: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""One or more member that are part of the Data Access Committee referenced in this submission.""")
...
class Biospecimen(MaterialEntity):
    ...
    has_individual: Optional[str] = Field(None, description="""The Individual entity from which this Biospecimen was derived.""")
...
class Family(Population):
    ...
    """
    has_member: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""One or more Individuals that collectively define this Family.""")
    has_proband: Optional[str] = Field(None, description="""The Individual that is reported to have a disorder which results in the Family being brought into a Study.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: Optional[str] = Field(None, description="""The name for an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: Optional[str] = Field(None, description="""The alias for an entity.""")
...
class Cohort(Population):
    ...
    """
    has_member: Optional[Union[List[AnnotatedIndividual], List[str]]] = Field(None, description="""One or more Individuals that collectively define this Cohort.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    name: Optional[str] = Field(None, description="""The name for an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: Optional[str] = Field(None, description="""The alias for an entity.""")
...
class Analysis(DataTransformation):
    ...
    has_study: Optional[str] = Field(None, description="""The Study entity associated with this Analysis.""")
...
class Experiment(Investigation):
    ...
    has_study: str = Field(None, description="""The Study entity associated with this Experiment.""")
...
class ExperimentProcess(PlannedProcess):
    ...
    has_input: Optional[str] = Field(None, description="""The input to the Experiment Process. Usually a Sample entity.""")
    has_protocol: Optional[str] = Field(None, description="""The Protocol entity used by this Experiment Process.""")
    has_agent: Optional[str] = Field(None, description="""The Agent - a software, institution, or human - that is executing or responsible for executing the Experiment Process.""")
    has_output: Optional[List[str]] = Field(None, description="""The output of this Experiment Process. Usually a File entity.""")
    has_attribute: Optional[List[Attribute]] = Field(None, description="""Key/value pairs corresponding to an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
    alias: Optional[str] = Field(None, description="""The alias for an entity.""")
    xref: Optional[List[str]] = Field(None, description="""Database cross references for an entity.""")
...
class Protocol(InformationContentEntity):
    ...
    has_file: Optional[str] = Field(None, description="""A document that describes the Protocol.""")
...
class LibraryPreparationProtocol(Protocol):
    ...
    has_file: Optional[str] = Field(None, description="""The file associated with an entity.""")
...
class Sample(MaterialEntity):
    ...
    isolation: Optional[str] = Field(None, description="""Method or device employed for collecting/isolating a biospecimen or a sample.""")
    storage: Optional[str] = Field(None, description="""Methods by which a biospecimen or a sample is stored (e.g. frozen in liquid nitrogen).""")
    has_individual: Optional[str] = Field(None, description="""The Individual from which this Sample was derived from.""")
    ...
    has_biospecimen: Optional[str] = Field(None, description="""The Biospecimen from which this Sample was prepared from.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: Optional[str] = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
    has_attribute: Optional[List[Attribute]] = Field(None, description="""Key/value pairs corresponding to an entity.""")
    id: str = Field(None, description="""An identifier that uniquely represents an entity.""")
...
class DataAccessPolicy(InformationContentEntity):
    ...
    has_data_access_committee: str = Field(None, description="""The Data Access Committee linked to this policy.""")
...
class Study(Investigation):
    ...
    has_project: Optional[str] = Field(None, description="""The project associated with this Study.""")
...
class Dataset(InformationContentEntity):
    ...
    has_data_access_policy: str = Field(None, description="""The Data Access Policy that applies to this Dataset.""")
    accession: Optional[str] = Field(None, description="""A unique GHGA identifier assigned to an entity for the sole purpose of referring to that entity in a global scope.""")
    ega_accession: Optional[str] = Field(None, description="""A unique European Genome-Phenome Archive (EGA) identifier assigned to an entity for the sole purpose of referring to that entity within the EGA federated network.""")
