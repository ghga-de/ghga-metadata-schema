...
[![img](https://yuml.me/diagram/nofunky;dir:TB/class/[MaterialEntity],[MaterialEntity]^-[CellLine&#124;id(i):string;alias(i):string;xref(i):string%20%2B;creation_date(i):string;update_date(i):string;schema_type(i):string;schema_version(i):string])](https://yuml.me/diagram/nofunky;dir:TB/class/[MaterialEntity],[MaterialEntity]^-[CellLine&#124;id(i):string;alias(i):string;xref(i):string%20%2B;creation_date(i):string;update_date(i):string;schema_type(i):string;schema_version(i):string])
