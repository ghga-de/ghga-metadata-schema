...
URI: [GHGA:metadata_mixin_schema_version](https://w3id.org/GHGA/metadata_mixin_schema_version)


## Domain and Range

[MetadataMixin](MetadataMixin.md) &#8594;  <sub>1..1</sub> [String](types/String.md)

## Parents

 *  is_a: [schema version](schema_version.md)
 ...
 * [Member](Member.md)
 * [MetadataMixin](MetadataMixin.md)
