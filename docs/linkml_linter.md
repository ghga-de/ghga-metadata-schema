...
### /workspace/src/schema/submission_centric_schema.yaml
#### Errors
...
* no_empty_title: Slot 'target regions' has no title
...
* standard_naming: Class has name 'disease'
...
* standard_naming: Slot has name 'umi barcode offset'
